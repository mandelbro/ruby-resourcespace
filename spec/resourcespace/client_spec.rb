...
RSpec.describe ResourceSpace::Client do
  ...
  describe "#initialize" do
    ...
    it "raises ConfigurationError with invalid configuration" do
      ...
      }.to raise_error(ResourceSpace::ConfigurationError)
    end
  ...
  describe "#get" do
    ...
    it "raises appropriate error for 404 response" do
      ...
      }.to raise_error(ResourceSpace::NotFoundError)
    end
    ...
    it "raises appropriate error for 401 response" do
      ...
      }.to raise_error(ResourceSpace::AuthenticationError)
    end
  end
  ...
  describe "#post" do
    ...
    it "handles validation errors" do
      ...
      }.to raise_error(ResourceSpace::ValidationError)
    end
  end
  ...
  describe "#test_connection" do
    ...
    it "raises error when connection fails" do
      ...
      }.to raise_error(ResourceSpace::ServerError)
    end
  end
  ...
  describe "error handling" do
    it "handles JSON parsing errors" do
      ...
      expect {
        client.get("get_system_status")
      }.to raise_error(ResourceSpace::ParseError)
    end
